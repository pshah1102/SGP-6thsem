...
// import React from "react";
 import background from "../../images/charusat1.png";

// import { margin, padding } from '@mui/system';
// const Signup=()=>{
// const paperStyle={padding:'25px 15px',width:300,margin:'20px auto',marginTop:'50px',paddingRight:'10px'}
// const headerStyle={margin:0}
// const avatarStyle={backgroundColor:'blue'}
//     return(
//             <Container style={{backgroundImage:`url(${background})`,backgroundRepeat:"no-repeat"}}>
